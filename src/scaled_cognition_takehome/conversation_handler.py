...
class LLMHandler:
    ...
    def add_tool_call_to_messages(self, tool_call, tool_response: dict | str) -> None:
        """
    ...
    @retry(max_retries=3)
    def get_response_with_tool(self) -> ChatCompletion:
        """
        Retrieves a response using the chat completion API with the specified tool.
...
class ConversationHandler:
    ...
    def get_image_for_weather(self, weather_data: WeatherData) -> str:
        ...
        return image.get("image_url", image.get("thumbnail_url"))
